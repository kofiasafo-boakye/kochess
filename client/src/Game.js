...
function Game({ players, room, orientation, cleanup }) {
  ...
  return (
    <Stack>
      <Box sx ={{display: "flex",fontFamily: "Rubik", alignSelf: "center", marginTop: "20px"}}>
        Room ID: {room}
      </Box>
      <Container maxWidth = "sm" direction="row" sx={{  alignContent: "center", justifyItems:"center"}}>
